...
/**
 * @brief 关键帧类
 * @detials 关键帧和普通的Frame不一样，可由Frame来构造; 许多数据会被三个线程同时访问，用锁的地方很普遍
 * 
 */
class KeyFrame {
public:
    ...
    cv::Mat GetRotation();              /// 获取旋转
    cv::Mat GetTranslation();           /// 获取平移
